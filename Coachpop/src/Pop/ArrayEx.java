...
public class ArrayEx {
	...
	public static void main(String[] args) {
		...
		/*
		 * System.out.println(myArray[0]); System.out.println(myArray[1]);
		 * System.out.println(myArray[2]); System.out.println(myArray[3]);
		 * System.out.println(myArray[4]); System.out.println(myArray[5]);
		 */
		/*
		...
		String[][] name = { { "Mr. ", "Mrs. ", "Ms. " }, { "Smith", "Jones" } };
